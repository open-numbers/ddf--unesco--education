...
LAST_UPDATE = "2023-09-23"  # Example date, replace with actual last update date
...
def check_for_new_version():
    ...
    data = response.json()
    education_theme = next(theme for theme in data['themeDataStatus'] if theme['theme'] == 'EDUCATION')
